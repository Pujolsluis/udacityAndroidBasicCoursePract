...
public class EarthquakeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FetchInBackgroundEarthquakeData fetchQuakeData = new FetchInBackgroundEarthquakeData();
        fetchQuakeData.execute("http://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&eventtype=earthquake&orderby=time&minmag=6&limit=10");
//        Log.v(LOG_TAG, earthquakes.get(0).getmLocation());
    ...
    private class FetchInBackgroundEarthquakeData extends AsyncTask<String, Void, ArrayList<Earthquake> >{
