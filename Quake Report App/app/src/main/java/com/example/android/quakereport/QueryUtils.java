...
public final class QueryUtils {
     ...
     */
    public static ArrayList<Earthquake> extractEarthquakesData(String jsonResponse) {
        ...
        try {
            ...
            JSONArray earthquakesJSONArray = rootObject.optJSONArray("features");

//            String size =  "" + earthquakesJSONArray.length();
//            Log.d(LOG_TAG, size);
            for(int i=0; i<earthquakesJSONArray.length(); i++){
                JSONObject currEarthquake = earthquakesJSONArray.getJSONObject(i);
                JSONObject currEarthquakeProperties = currEarthquake.optJSONObject("properties");
                double magnitude = currEarthquakeProperties.optDouble("mag");
                String place = currEarthquakeProperties.optString("place");
                Long date = currEarthquakeProperties.optLong("time");
...
//                Log.d(LOG_TAG, "This Earthquake info is " + magnitude+ " " + place + " "+ date);
    ...
    public static ArrayList<Earthquake> fetchEarthquakeData(String requestUrl) {
        ...
        ArrayList<Earthquake> earthquakeList = extractEarthquakesData(jsonResponse);
